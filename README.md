...
The number of orders exceeds the number of customers, indicating repeat purchases.

The average order value is relatively high, suggesting revenue is driven by higher value transactions rather than volume alone.
...
DAX Measures
Total Customers = DISTINCTCOUNT(Online_Retail_eda_clean_Data[CustomerID])

Total Orders = DISTINCTCOUNT(Online_Retail_eda_clean_Data[InvoiceNo])

Total Revenue = SUM(Online_Retail_eda_clean_Data[Revenue])
